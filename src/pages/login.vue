    ...
    <q-page-container>
      <q-page class="flex flex-center">
        ...
        <q-card
          ...
          "
        >
          <q-img src="~assets/crm.webp" style="max-height: 150px; border-top-left-radius: 10px; border-top-right-radius: 10px"></q-img>
          <q-card-section>
            <q-avatar
              size="74px"
              class="absolute"
            ...
            >
              <img :src="`${server}/storage/users/user.png`"/>
            </q-avatar>
          ...
          <q-card-section>
            <q-form class="q-gutter-md">
              <q-input filled v-model="user.email" label="Correo" lazy-rules>
              ...
              <div>
                ...
                <a
                  ...
                  class="float-right"
                  href="https://github.com/eddyjj92"
                  target="_blank"
                  title="Donate"
...
import {server} from "boot/axios.js";
